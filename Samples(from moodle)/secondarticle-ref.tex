% Sample file: secondarticle-ref.tex
% The sample article secondarticle.tex for the amsart document class 
% with hyperref

\documentclass{amsart}
\usepackage{amssymb,latexsym}
\usepackage[pagebackref,colorlinks,bookmarks=true]{hyperref}
...
\urladdr{\href{http://math.uwinnebago.edu/menuhin/}http://math.uwinnebago.edu/menuhin/}
...
\begin{definition}\label{D:P*} 
   ...
   satisfying condition~\eqref{j-i}.  Their $\Pi^{*}$ product is defined as follows:
   \[
      \Pi^{*} ( D_{i} \mid i \in I ) = \Pi ( D_{i}^{-} 
          \mid i \in I ) + 1;
   \]
...
The Main Theorem follows easily from \autoref{T:P*} and \autoref{T:P*a}.
